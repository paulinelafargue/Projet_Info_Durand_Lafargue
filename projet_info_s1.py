...
Original file is located at
    https://colab.research.google.com/gist/paulinelafargue/a25e182822483615b8eb78434a7ccb91/projet_info_s1.ipynb
"""
...
if (__name__ = 'main'):
  main()
  echo "# paulinelafargue" >> README.md 
git init 
git add README.md 
git commit -m "first commit" 
git branch -M main 
git remote add origin https://github.com/paulinelafargue/paulinelafargue.git
